...
`,f=e.ZP.div`
    ...
    top: 0;
    bottom: 0;
`;const v=({disableKeyboard:t,grid:r,players:n,onGameUpdate:o,onGameFinished:a,onGameReset:l})=>{const{winner:i,playsLeft:e}=function(r){let t=-1,n=0,o=!0;var a=Math.sqrt(r.length);for(let e=0;e<a;e++){var l=e*a,i=r[l],c=r[1+l],l=r[2+l],s=r[e],d=r[e+a],m=r[e+2*a];-1===i&&n++,-1===c&&n++,-1===l&&n++,o&&-1!==i&&i===c&&i===l&&(t=i,o=!1),o&&-1!==s&&s===d&&s===m&&(t=s,o=!1),0===e&&o&&-1!==r[e]&&r[e]===r[a+1]&&r[e]===r[2*(a+1)]&&(t=r[e],o=!1),2===e&&o&&-1!==r[e]&&r[e]===r[e*e]&&r[e]===r[e*a]&&(t=r[e],o=!1)}return{winner:t,playsLeft:n}}(r),c=0===e||-1!==i,s=Math.sqrt(r.length),d=({position:e})=>{o({position:e})};return(0,m.useEffect)(()=>{const e=e=>{var r;if(!t)return r=+e.key.trim(),c?/enter/i.test(e.key)&&l():r&&!isNaN(r)&&o({position:function(e){if(9<e||e<1)throw new Error("Number must be less that 10 and greater than 0");return 6<e?e-7:3<e?e-1:e+5}(r)}),e.preventDefault(),!1};return document.addEventListener("keypress",e),c&&a({grid:r,winner:n[i]}),()=>document.removeEventListener("keypress",e)},[t,c]),m.createElement(g,null,m.createElement(u,{size:s,disabled:c},r.map((e,r)=>m.createElement(p,{onClick:d,position:r,size:s,key:r,player:e}))),c&&m.createElement(f,null,m.createElement(h,{player:n[i],onResetGame:()=>{l()}})))};t=r(602);const P=e.ZP.div`
    width: 100px;
    position: relative;
    display: flex;
    flex-direction: column;
